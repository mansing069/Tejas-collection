...
public class Vector1 {
	...
	public static void main(String[] args) {
		...
		List<Integer> numberList =new Vector<>(); // change only ArrayList to Linked List.
		numberList.add(10);
		numberList.add(20);
		numberList.add(30);
		...
		List<Integer>arrayList=Arrays.asList(50,60,70);
		System.out.println("After adding New element " +arrayList);
